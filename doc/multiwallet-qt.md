...
In order to support loading of multiple wallets in bandera-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bandera.cpp.
...
Changes to bandera.cpp
----------------------
bandera.cpp is the entry point into bandera-qt, and as such, will require some minor modifications to provide hooks for
