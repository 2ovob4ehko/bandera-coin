Contributing to Bandera
============================

The Bandera project operates an open contributor model where anyone is
...
The following applies to code changes to the Bandera project, and is not to be
confused with overall Bandera Network Protocol consensus changes.

Whether a pull request is merged into Bandera rests with the project merge
...
Patches that change Bandera consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bandera consensus, it must have been
...
The project leader is the release manager for each Bandera release.
