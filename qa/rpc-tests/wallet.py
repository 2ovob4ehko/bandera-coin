...
#   c) node1 mines 32 blocks, so now node 0 has 60001 bandera, node 1 has 4250 bandera, node2 has none.
#   d) node0 sends 601 bandera to node2, in two transactions (301 bandera, then 300 bandera).
