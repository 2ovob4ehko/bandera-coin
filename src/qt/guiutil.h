...
/** Utility functions used by the Bandera Qt UI.
 */
namespace GUIUtil
{
...
// Render Bandera addresses in monospace font
...
// Parse "bandera:" URI into recipient object, return true on successful parsing
