                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Bandera from zBANDERA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBANDERA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBANDERA));
